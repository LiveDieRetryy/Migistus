...
import { 
  ...
  Package, Target, Timer, BarChart3, AlertCircle
} from "lucide-react";
...
export default function VotingPage() {
  ...
  const getTimeUntilReset = (): string => {
    ...
    return hoursUntilReset > 0 ? `${hoursUntilReset}h ${minutesUntilReset}m` : `${minutesUntilReset}m`;
  };
  ...
  const getTierIcon = (tier: string | undefined) => {
    if (!tier) return <Users className="w-4 h-4" />;
    switch (tier) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-black text-white">
        ...
        <div className="relative overflow-hidden pt-8 pb-16">
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-gradient-to-br from-yellow-900/20 via-transparent to-purple-900/20" />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
              <div className="flex justify-center mb-6">
                <div className="relative">
                  ...
                  <Vote className="relative w-20 h-20 text-yellow-400 drop-shadow-lg" />
            ...
            {isAuthenticated && user ? (
              <div className="max-w-4xl mx-auto">
                <div className="bg-gradient-to-br from-zinc-800/80 to-zinc-900/80 backdrop-blur-xl border border-zinc-700/50 rounded-2xl p-6 shadow-2xl">
                  <div className="grid md:grid-cols-3 gap-6">
                    {/* Tier Status */}
                    <div className="text-center">
                      <div className="flex items-center justify-center mb-3">
                        {getTierIcon(user.tier)}
                        <span className={`ml-2 text-lg font-bold ${getTierColor(user.tier)}`}>
                          {user.tier || "Initiate"}
                        </span>
                      </div>
                    ...
                    <div className="text-center border-x border-zinc-700/50">
                      ...
                      <div className="text-sm text-zinc-400">Votes Remaining</div>
                      {getRemainingVotes() === 0 && (
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm text-zinc-400">Vote Power</div>
                    </div>
                  </div>

                  <button
                    onClick={() => setShowVotingModal(true)}
                    className="w-full mt-6 flex items-center justify-center gap-2 px-4 py-2 bg-zinc-700/50 hover:bg-zinc-600/50 border border-zinc-600 rounded-xl text-zinc-300 hover:text-white transition-all duration-200 text-sm"
                  >
              ...
              <div className="max-w-2xl mx-auto text-center">
                <div className="bg-gradient-to-br from-zinc-800/80 to-zinc-900/80 backdrop-blur-xl border border-zinc-700/50 rounded-2xl p-8">
                  <AlertCircle className="w-12 h-12 text-yellow-400 mx-auto mb-4" />
                  <h3 className="text-2xl font-bold text-white mb-3">Login to Start Voting</h3>
                  <p className="text-zinc-300 mb-6">
                    Join MIGISTUS to vote for the products you want to see. Your voice matters!
                  </p>
          ...
          {loading ? (
            ...
            <div className={
              ...
              {filteredProducts.map((product) => {
                ...
                const canVote = isAuthenticated && !isVoted && getRemainingVotes() > 0;
          ...
          >
            <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-700 rounded-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
              ...
              {votingConfig && (
                <div className="p-8">
                  {/* Overview */}
                  <div className="mb-8 p-6 bg-gradient-to-br from-yellow-900/20 to-orange-900/20 border border-yellow-500/30 rounded-xl">
                    <h3 className="text-xl font-bold text-yellow-400 mb-3 flex items-center gap-2">
                      <Target className="w-5 h-5" />
                      Your Vote Shapes MIGISTUS
                    </h3>
                    <p className="text-zinc-300 leading-relaxed">
                      Every vote counts toward which products make it to our marketplace. Products with the most weighted votes 
                      will be prioritized for upcoming drops. Higher-tier members have increased voting power to reflect their 
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {Object.entries(votingConfig.tierLimits || {}).map(([tier, limit]) => (
                          <div key={tier} className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-4 hover:bg-zinc-700/50 transition-colors">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                ...
                                <span className={`text-lg font-bold ${getTierColor(tier)}`}>{tier}</span>
                              </div>
                              <div className="text-right">
                                <div className="text-2xl font-black text-white">{limit}</div>
                                <div className="text-xs text-zinc-400">votes/day</div>
                              </div>
                            </div>
                          </div>
                        ))}
                  ...
                  <div className="mt-8 grid md:grid-cols-2 gap-4">
                    <div className="p-5 bg-blue-500/10 border border-blue-500/30 rounded-xl">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="font-bold text-blue-300 mb-1">Daily Reset</div>
                          <p className="text-sm text-blue-200">
                            Your voting limits reset every day at midnight. Plan your votes strategically!
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-5 bg-green-500/10 border border-green-500/30 rounded-xl">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="font-bold text-green-300 mb-1">Impact Matters</div>
                          <p className="text-sm text-green-200">
                            Products with high weighted scores are prioritized for Coming Soon and Live Drops stages.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-5 bg-purple-500/10 border border-purple-500/30 rounded-xl">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="font-bold text-purple-300 mb-1">Tier Benefits</div>
                          <p className="text-sm text-purple-200">
                            Upgrade your tier to unlock more daily votes and increase your voting power.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-5 bg-orange-500/10 border border-orange-500/30 rounded-xl">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="font-bold text-orange-300 mb-1">Track Trending</div>
                          <p className="text-sm text-orange-200">
                            See which products are gaining momentum and vote for your favorites before they're gone!
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* CTA */}
                  {!isAuthenticated && (
                    <div className="mt-8 text-center p-6 bg-gradient-to-br from-yellow-900/30 to-orange-900/30 border border-yellow-500/50 rounded-xl">
                      <h4 className="text-xl font-bold text-white mb-3">Ready to Make Your Voice Heard?</h4>
                      <p className="text-zinc-300 mb-6">Join MIGISTUS today and start voting for the products you want to see!</p>
                      <div className="flex gap-4 justify-center">
                        <Link
                          href="/register"
                          className="px-8 py-4 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-black font-bold rounded-xl transition-all duration-200 hover:scale-105 shadow-lg shadow-yellow-500/50"
                        >
                          Register Now
                        </Link>
                        <Link
                          href="/login"
                          className="px-8 py-4 bg-zinc-700 hover:bg-zinc-600 text-white font-bold rounded-xl transition-all duration-200"
                        >
                          Login
                        </Link>
                      </div>
