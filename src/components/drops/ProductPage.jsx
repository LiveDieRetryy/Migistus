          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 bg-gray-800/50 px-3 py-2 rounded-lg border border-gray-700">
                ...
                <span className="text-sm text-yellow-300 font-medium">Guild Member</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            {/* Current Price */}
            <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-2xl border border-gray-700 p-8 overflow-hidden">
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Product Details */}
          <div className="lg:col-span-2 bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl shadow-2xl border border-gray-700 p-8">
          ...
          <div className="relative bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl shadow-2xl border border-gray-700 p-6">
            <div className="flex items-center justify-between mb-6">
            ...
            {hasPledged ? (
              ...
              <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/50 rounded-xl p-4 border border-gray-600 text-center">
                <div className="flex items-center justify-center space-x-2 mb-2">
                  <MessageCircle className="w-5 h-5 text-gray-400" />
                  <span className="text-gray-300 font-medium">Join the conversation</span>
                </div>
                <p className="text-sm text-gray-400 mb-3">
                  Pledge to this drop to unlock community chat, reactions, and exclusive discussions.
                </p>
                <button 
                  onClick={() => setShowPledgeModal(true)}
                  className="bg-gradient-to-r from-yellow-600 to-yellow-500 text-black px-6 py-2 rounded-lg font-semibold hover:shadow-lg hover:shadow-yellow-500/50 transition-all"
                >
                  Join Drop to Chat
                </button>
              </div>
